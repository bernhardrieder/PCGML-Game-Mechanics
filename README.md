...
- Press the play button or ALT+P and you should find yourself in the main menu. Don't panik if it freezes after pressing the "Start Scenario" button! It just takes a few moments to load all the dlls.

...
\end{figure}\\
Now, the \ac{VAE} makes use of the same technique as the regular autoencoder but alters the latent space to map the input data distribution into the feature space onto a normal distribution.

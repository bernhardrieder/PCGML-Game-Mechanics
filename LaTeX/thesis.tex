...
\begin{table}[!htbp]
	...
	{%
		\begin{tabular}{|p{2.1cm}||p{8cm}|p{4cm}|p{4cm}|}
			...
			\textbf{Visualized} & Visualization of AI system states and so that gameplay revolves around state manipulation & Observation and manipulation of an AI system & Shows states and gives information \\ \hline

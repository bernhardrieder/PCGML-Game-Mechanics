...
\section{Development}
There are no specific development considerations to make when the combination of PCG and ML is used. Instead, every design consideration, possible issue, pitfall and best practices described and discussed in chapters \ref{pcgDevelopment} and \ref{mlDevelopment} apply when implementing PCGML algorithms.\\
Nevertheless, it is worth mentioning that common used training models for research purposes were neural networks like \ac{ANN}, \ac{CNN} or \ac{LSTM} networks; Markov models such as n-grams or multi-dimensional Markov chains; autoencoders; clustering; matrix factorization or Bayes models \cite{pcgml::paper}. The models which will be used for the implementation of a PCGML game mechanic will be described in detail if needed.

...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.7\linewidth]{PICs/variational_autoencoder}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=1.0\linewidth]{PICs/ingame_screenshot}

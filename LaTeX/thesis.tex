...
\subsection{Necessary Hardware}
GPU needs to be applicable with NVidia's CUDA library if GPU version of TensorFlow is used. Especially, this is important when the game uses online training and should be finished in a feasable time.

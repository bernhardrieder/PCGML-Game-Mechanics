...
mention again the suitable game mechanic which is implemented in the game porottype and mention the focus of this chapter on this mechanic - but that the proccess can also be used and is applicable for other PCGML mechanics.

mention data aquisition for the model and also a necessary game design for the prototype


blah blah blah, what does this chapter address? talk about the content of this chapter

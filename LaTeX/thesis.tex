...
\subsection{Data}
First of all, it is necessary to come up with efficient and enough data for the system's training. Depending on the variables does it need more ore less data for the model. For example, a data structure with around ten variables would probably need at least 100 data rows to properly train the ML model.
\subsection{Training}

...
This type of learning doesn't have a labeled sample set and has a different number of participating elements, which include an agent, an environment, and learning an optimum policy or set of steps, maximizing a goaloriented approach by using rewards or penalties (the result of each attempt).\cite{ml::book::developer}

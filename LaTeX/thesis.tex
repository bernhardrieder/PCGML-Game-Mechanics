...
\begin{itemize}
	...
	\item Each game element need proper design and balancing.
	\item Training of the ML model can be hard because element can consist of many values which create complex dependencies.
	\item The configurations which are used for the training need to secure playability.
	\item Game design must include a broad range of game elements.
\end{itemize}
...
\subsection{Game Mechanic Ideas Summary}
